...
const MENUITEMS: Menu[] = [
  ...
  },
  {
    ...
    children: [{ state: 'not-found', name: 'Add Method' }, { state: 'not-found', name: 'Method List' }],
  },
  {
  ...
  },
  {
    ...
    type: 'sub',
    icon: 'map',
    children: [{ state: 'not-found', name: 'Add Comments' },
     { state: 'not-found', name: 'Comments List' }],
  },
  {
    state: 'format',
    name: 'Format',
    type: 'sub',
    icon: 'get_app',
    children: [{ state: 'not-found', name: 'Add Format' },
     { state: 'not-found', name: 'Format List' }],
  },
  {
    state: 'coupons',
  ...
  },
  {
    ...
    type: 'sub',
    icon: 'supervised_user_circle',
    children: [{ state: 'not-found', name: 'Add Promotion' },
     { state: 'not-found', name: 'Promotion Corner List' }],
  },
  {
    state: 'payment',
  ...
  },
  {
    ...
    type: 'sub',
    icon: 'pages',
    children: [{ state: 'not-found', name: 'Add Email Gateway' },
     { state: 'not-found', name: 'Email Gateway List' }],
  },
  {
    state: 'sms',
    name: 'SMS Gateways',
    type: 'sub',
    icon: 'pages',
    children: [{ state: 'not-found', name: 'Add SMS Gateway' },
     { state: 'not-found', name: 'SMS Gateway List' }],
  },
  {
    state: 'news',
    name: 'News',
    type: 'sub',
    icon: 'pages',
    children: [{ state: 'not-found', name: 'Add News' },
     { state: 'not-found', name: 'News List' }],
  },
  {
    state: 'whatsapp',
