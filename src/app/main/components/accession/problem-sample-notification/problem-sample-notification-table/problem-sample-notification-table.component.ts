...
@Component({
  selector: 'app-problem-sample-notification-table',
  templateUrl: './problem-sample-notification-table.component.html',
  styleUrls: ['./problem-sample-notification-table.component.scss'],
})
export class ProblemSampleNotificationTableComponent {
